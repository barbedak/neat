...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference("Equipment.count") do
      post equipment_index_url, params: { equipment: { equipment_type_name: @equipment.equipment_type_name, name: @equipment.name } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { equipment_type_name: @equipment.equipment_type_name, name: @equipment.name } }
